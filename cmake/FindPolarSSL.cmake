...
#get system head files
  ...
  execute_process(
   COMMAND ${CMAKE_C_COMPILER} ${PROJECT_BINARY_DIR}/a.c -I${POLARSSL_INCLUDE_DIRS}  ${POLARSSL_LIBRARIES} -o ${PROJECT_BINARY_DIR}/a
  )
...
message("****Info**** POLARSSL_INCLUDE_DIRS is ${POLARSSL_INCLUDE_DIRS}")
message("****Info**** POLARSSL_LIBRARIES is ${POLARSSL_LIBRARIES}")
message("****Info**** POLARSSL_VERSION_STRING is ${POLARSSL_VERSION_STRING}")
message("****Info**** POLARSSL_INC_FOLDER is ${POLARSSL_INC_FOLDER}")
